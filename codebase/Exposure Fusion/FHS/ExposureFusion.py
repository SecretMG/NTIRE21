...
class ExposureFusion():
    ...
    def MultiScaleFusion(self, depth=6):
        ...
        LapPyrs_final = self.LapMerge(LapPyrs, GauPyrs) # 用W的Gauss金字塔指导I的Laplace金字塔的合成
        ...
        ImgBase = self.Fusion(GauBase, WeightBase)  # 用小图的高斯权重来指导小图的加权和
...
if __name__=='__main__':
    ...
    ImgShow(naive_result, name='Naive Result', wait=True)
